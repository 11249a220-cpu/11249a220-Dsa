...
To create and manipulate a singly linked list in C language. The program should allow basic operations such as:
...
4.Traversing (displaying) the list
...
Otherwise, traverse to the node before the node to delete
...
Print each node’s data until NULL
